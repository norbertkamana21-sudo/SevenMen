...
local ProtectionConfig = {
    ...
    SecretKey = "12345", -- The secret key that the Key System sets as a global variable
...
local Config = {
    ...
    ServiceId       = 26797, -- Your PlatoBoost Service ID
    PlatoSecret     = "56bbf5d5-e6e5-44f4-ab1f-c89f9aa53e82", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "12345", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    ...
    HubName         = "Ray's Example UI", -- The main title shown at the top of the GUI
    HubDescription  = "Just complete the platoboost to continue." -- The text shown below the title
}
